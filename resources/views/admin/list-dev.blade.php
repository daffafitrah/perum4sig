                    ...
                    <div class="col-lg-12 d-flex align-items-stretch">
                        <div class="card w-100">
                            <div class="card-body p-4">
                                <h5 class="card-title fw-semibold mb-4">List Developer</h5>
                                @if (session()->has('msg'))
                                    ...
                                    <table class="table text-nowrap mb-0 align-middle">
                                        <thead class="text-dark fs-4">
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">
                                                    <h6 class="fw-semibold mb-0 text-center">Nama Perusahaan</h6>
                                                </th>
                                        ...
                                        <tbody>
                                            @foreach ($perusahaan as $key => $pers)
                                                <tr align="center">
                                                    <td class="border-bottom-0">
                                                        <h6 class="fw-semibold mb-0">{{ $key + 1 }}</h6>
                                                    </td>
                                                    <td class="border-bottom-0">
                                                        <h6 class="fw-semibold mb-1">{{ $pers->nama_pers }}</h6>
                                                    </td>
                                                    ...
                                                    <td class="border-bottom-0">
                                                        <div
                                                            ...
                                                            <span
                                                                class="badge bg-primary rounded-3 fw-semibold">{{ $pers->telp_pers }}</span>
                                                        </div>
                                                    </td>
                                                    <td class="border-bottom-0">
                                                        ...
                                                        <button type="button" class="btn btn-primary"
                                                            ...
                                                            data-bs-target="#detailModal{{ $pers->id_pers }}">
                                                            <i class="fa-solid fa-eye"></i>
                                                        </button>

                                                        <!-- Modal -->
                                                        <div class="modal fade" id="detailModal{{ $pers->id_pers }}"
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="exampleModalLabel">Informasi Perusahaan
                                                                        </h5>
                                                        ...
                                                        <a href="/edit-dev/{{ $pers->id_pers }}"
                                                            class="btn btn-outline-primary"><i
                                                                class="fa-solid fa-pen-to-square"></i></a>
                                                        <button type="button" class="btn btn-danger"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#deleteModal{{ $pers->id_pers }}">
                                                            <i class="fa-solid fa-trash"></i>
                                                        </button>

                                                        <!-- Modal -->
                                                        <div class="modal fade" id="deleteModal{{ $pers->id_pers }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="/delete-pers/{{ $pers->id_pers }}"
                                                                            method="post">
                                                                            @csrf
                                                                            @method('DELETE')
