        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4">Formulir Perumahan</h5>
                            @if (session()->has('msg'))
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="/add-perum" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="id_pers" class="form-control" required>
                                                ...
                                                @foreach ($perusahaan as $pers)
                                                    <option value="{{ $pers->id_pers }}">{{ $pers->nama_pers }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
