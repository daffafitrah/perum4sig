                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="./index.html" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                    <img src="../assets/images/logos/logo-home.png" width="180" alt="" />
                                </a>
                                ...
                                <form action="/login" method="POST">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <a href="/" type="button"
                                            class="btn btn-outline-secondary w-100 py-8 fs-4 mb-4 rounded-2">WEBSITE</a>
                                    </div>
                                </form>
                            </div>
                        </div>
